...
@Controller // 해당 스프링MVC에서 컨트롤러 역할 , 스프링의 빈(Bean)으로 등록처리하겠다.
@Log4j2
public class SampleController {
    ...
    public String ex5(RedirectAttributes redirectAttributes){
       redirectAttributes.addAttribute("name","AAABBBCCC");
       redirectAttributes.addFlashAttribute("result","success"); // 일회용임 새로고침하면 없어짐
       return "redirect:/ex6";
    }
    @GetMapping("/ex6")
    public void ex6(){}
